...
public class FileRegister {
    ...
    public FileRegister(String fileName, Console console) {
    ...
    public ArrayList<Movie> readCsv() throws FileNotFoundException, WrongNumberException,
    ...
    public void writeCsv(Stack<Movie> movies) throws FileNotFoundException {
